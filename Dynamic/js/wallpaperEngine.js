...
window.wallpaperPropertyListener = {
  applyUserProperties: function(properties) {
      ...
      if (!runAnimations) {
        $('#landscape .layer11').css('animation', 'treecolor 86400s linear 2s infinite');
      } else {
        $('#landscape .layer11').css('animation', 'treesway 60s linear 2s infinite, treecolor 86400s linear 2s infinite');
      }
  },
